...
#
# Pull library version from ndef_version.h
#

VERSION_FILE = $(INCLUDE_DIR)/ndef_version.h
get_version = $(shell grep -E '^.+define +NDEF_VERSION_$1 +[0-9]+$$' $(VERSION_FILE) | sed 's/  */ /g' | cut -d ' ' -f 3)
